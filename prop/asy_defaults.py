...
import numpy as np
from .asy_prop import al,ahl,aql,a1hl,a2l, index_to_deg, index_to_rad
...
range_a2l_rad = range_a2l * index_to_rad
...
'range_a2l_deg','range_a2l_rad','birange_aql','birange_ahl','trig_weights')